...
arm-himix100-linux-gcc sample_venc.c -o sample_venc common/*.o ./libhi3518ev300.a -I./include -I./common -Dhi3516ev200 -DHI_XXXX -lpthread -lm -ldl -DISP_V2  -lstdc++ -DSENSOR0_TYPE=OMNIVISION_OS05A_MIPI_5M_30FPS_12BIT -DHI_ACODEC_TYPE_INNER -DHI_VQE_USE_STATIC_MODULE_REGISTER -DHI_AAC_USE_STATIC_MODULE_REGISTER -DHI_AAC_HAVE_SBR_LIB -ffunction-sections -Wl,-gc-sections
